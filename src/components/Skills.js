...
const Skills = () => {
    return (
        <section id="skills" className="skills__wrap">
            <h2>These are my current skills</h2>
            <div className="skills__carousel">
                <div className="skills__card --html">
                    <h3>HTML5</h3>
                ...
                <div className="skills__card --css">
                    <h3>CSS3</h3>
                    ...
                    <p>Good knowledge<br></br>SCSS<br></br>RWD<br></br>BEM</p>
                </div>
                <div className="skills__card --js">
